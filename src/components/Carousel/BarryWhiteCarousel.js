...
const BarryWhiteCarousel = () => {
  return (
    ...
    <h2 className='selenah2' style={{color:'#B30A14'}}>They say the key to a long-term relationship is falling in with your partner
    over and over again. Listening to Barry White feels like im falling in love everytime I listen. </h2>

  <Carousel>

      <CarouselItem>
        <h3 className='selenah6' style={{color:'#C51313'}}> You Sexy Thing</h3>
          <ReactPlayer className="reactPlayer" url ='https://www.youtube.com/watch?v=aOl4oeHZnBk' playsinline/>
