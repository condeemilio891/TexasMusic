...
const SpoonCarousel = () => {
  return (
      <>
    <h1 className='selenah1' style={{color:'#FF7861'}}>Spoon</h1>
    <h2 className='selenah2' style={{color:'white'}}>sda </h2>

  <Carousel>
      <CarouselItem>
      
        <h3 className='selenah6' style={{color:'#3B6DC2'}}> Spoon</h3>
          <ReactPlayer className="reactPlayer" url ='https://www.youtube.com/watch?v=IpT5SBg1Mmk'/>
