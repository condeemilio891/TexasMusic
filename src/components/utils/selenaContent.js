export const siUnaVezAccordionData = [
    {
      ...
      content: `Released: 1994
                ...
                Length:2:50 
                Label: EMI LATIN
                Songwriters:Pete AstudilloA.B. Quintanilla III
  ...
  export const bidibidibombomAccordionData=[
    {
        ...
        content: `  Released: July 1994
                    Recorded:1993-1994
                    Genre: Tejanodance-popreggae-popMexican cumbia
                    Length: 3:29
                    Label: EMI Latin
                    Songwriters:Selena Quintanilla-PérezPete Astudillo
...
[
    {
        ...
        Genre  TejanoMexican cumbiadance-poppop rock
        Length	35:27
        Language	Spanish
        Label	EMI Latin
...
[
    {
        ...
        Genre   Mariachibolerorancherasoft rock
        Length	3:16
        Label	EMI Latin
        Songwriter(s)	Ricky Vela
        Producer(s)	
        A.B. Quintanilla IIIBebu Silvetti`
...
[
    {
        ...
        Length	3:29
        Label	EMI Latin
        Songwriter(s)	Ricky Vela, A.B. Quintanilla, Samuel "Sammy" Morales
        Producer(s)	A.B., Bebu Silvetti`
